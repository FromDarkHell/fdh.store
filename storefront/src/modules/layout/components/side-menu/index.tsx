              ...
              >
                <PopoverPanel className="flex flex-col absolute w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-green-100 m-2 backdrop-blur-2xl font-mono">
                  ...
                  >
                    ...
                    {/* Decorative elements */}
                    <div className="absolute top-20 right-10 w-1 h-1 bg-blue-400 rounded-full animate-pulse"></div>
                    <div className="absolute bottom-20 left-10 w-1 h-1 bg-green-400 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                  </div>
                </PopoverPanel>
              </Transition>
            </>
